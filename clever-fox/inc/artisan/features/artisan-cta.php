<?php
function artisan_cta_setting( $wp_customize ) {
...
add_action( 'customize_register', 'artisan_cta_setting' );

// CTA selective refresh
function artisan_cta_section_partials( $wp_customize ){
...
add_action( 'customize_register', 'artisan_cta_section_partials' );
