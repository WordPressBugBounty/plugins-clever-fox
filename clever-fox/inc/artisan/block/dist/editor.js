 ...
 function oa(a) {
    ...
    (0, a.registerBlockType)("info-box/infos", {
        ...
        edit: function (a) {
            ...
            return wp.element.createElement(
                ...
                wp.element.createElement(
                    "div",
                    { className: o, id: "artisanInfos-".concat(O) },
                    wp.element.createElement("style", {
                        dangerouslySetInnerHTML: {
                            __html: "\n                    @import url("
                                .concat(O, " .artisanInfos .artisanInfo .title{\n                        ")
                                .concat(O, " .artisanInfos .artisanInfo .description{\n                        "),
                        },
                    }),
                    wp.element.createElement(
                        "div",
    ...
    var Da = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        t.PanelRow,
                        { className: "artisanIconTitle ".concat(n) },
        ...
        Ra = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        "div",
                        { className: i, id: "artisanInfo-".concat(x) },
                        wp.element.createElement("style", {
                            dangerouslySetInnerHTML: {
                                __html: "\n                #artisanInfo-"
                                    .concat(x, " .artisanInfo .bgLayer{\n                    ")
                                    .concat(x, " .artisanInfo .title{\n                    color: ")
                                    .concat(x, " .artisanInfo .icon{\n                    ")
                                    .concat((null == m ? void 0 : m.styles) || "font-size: 70px;", "\n                }\n                #artisanInfo-")
                                    .concat(x, " .artisanInfo .description{\n                    color: ")
                                    .concat(x, " .artisanInfo .link a svg{\n                    fill: "),
                            },
                        }),
                        wp.element.createElement(
                            "div",
							{ className: "artisanInfo av-column-".concat(m.desktop, " columns-tablet-").concat(m.tablet, " av-sm-column-").concat(m.mobile)},
    ...
    (0, a.registerBlockType)("info-box/info", {
        ...
        attributes: {
            ...
            title: { type: "string", selector: ".artisanInfo span.title", default: "Info title" },
            isDesc: { type: "boolean", default: !0 },
            desc: { type: "string", selector: ".artisanInfo h3.description", default: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, fuga." },
