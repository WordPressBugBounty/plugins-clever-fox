...
require CLEVERFOX_PLUGIN_DIR . 'inc/mukundra/features/hotel-26-packages.php';
require CLEVERFOX_PLUGIN_DIR . 'inc/mukundra/features/hotel-26-funfact.php';
...
if ( ! function_exists( 'cleverfox_hotel_26_frontpage_sections' ) ) :
	function cleverfox_hotel_26_frontpage_sections() {
		...
		require CLEVERFOX_PLUGIN_DIR . 'inc/mukundra/sections/section-tour-packages-2.php';
		require CLEVERFOX_PLUGIN_DIR . 'inc/mukundra/sections/section-funfact-2.php';
    }
endif;
