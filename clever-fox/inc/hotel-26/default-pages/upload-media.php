...
$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/hotel-26/images';

$cleverfox_images = array(
$cleverfox_file,
$cleverfox_ImagePath. '/blogs/1.jpg',
$cleverfox_ImagePath. '/blogs/2.jpg',
$cleverfox_ImagePath. '/blogs/3.jpg',
$cleverfox_ImagePath. '/blogs/4.jpg',
);
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'hotel_26_media_id', $cleverfox_ImageId );
