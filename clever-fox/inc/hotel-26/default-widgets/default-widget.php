<?php
	...
	if($cleverfox_name == 's') {
		$hotel_26_logo_url = CLEVERFOX_PLUGIN_URL .'inc/'.$cleverfox_name.'/images/logo.png';
	} else {
		$hotel_26_logo_url = CLEVERFOX_PLUGIN_URL .'inc/'.$cleverfox_name.'/images/footer-logo.png';
	}
	
$cleverfox_blocks = array(
    '<!-- wp:html -->
	<div class="logo mb-3">
		<a href="javascript:void(0);"><img decoding="async" src="'.$hotel_26_logo_url.'" alt="image"></a>
	</div>
	<div class="textwidget ">
		...
		<div class="footer-badge">
			<img decoding="async" src="'.CLEVERFOX_PLUGIN_URL .'inc/hotel-26/images/footer/2.png" alt="">
			<img decoding="async" src="'.CLEVERFOX_PLUGIN_URL .'inc/hotel-26/images/footer/3.png" alt="">
			<img decoding="async" src="'.CLEVERFOX_PLUGIN_URL .'inc/hotel-26/images/footer/4.png" alt="">		   
		</div>
	</div>
...
$cleverfox_activate = array(
		'hotel-26-footer-1' => array(
			'block-2'
        ),
		'hotel-26-footer-2' => array(
            'block-3'
        ),
		'hotel-26-footer-3' => array(
            'block-4'
        ),
		'hotel-26-footer-4' => array(
			'block-8'
        ),
        'hotel-26-sidebar-primary' => array(
            'block-5',
            'block-6',
            'block-7',
            'block-8',
