	...
	return apply_filters(
		'hotel26_info_two_default', json_encode(
				...
				array(
					...
					'title' 		=> esc_html__( 'Book Your Appointment', 'clever-fox' ),
					'description' 		=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'clever-fox' ),
					'button_text' 		=> esc_html__( 'Read More', 'clever-fox' ),
					'button_link' 		=> '',
					'newtab' 		=> '',
					'nofollow' 		=> '',
				...
				array(
					...
					'title' 		=> esc_html__( 'Our Commitment to Safety', 'clever-fox' ),
					'description' 		=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'clever-fox' ),
					'button_text' 		=> esc_html__( 'Read More', 'clever-fox' ),
					'button_link' 		=> '',
					'newtab' 		=> '',
				...
				array(
					...
					'title' 		=> esc_html__( 'Gift of Wellness', 'clever-fox' ),
					'description' 		=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'clever-fox' ),
					'button_text' 		=> esc_html__( 'Read More', 'clever-fox' ),
					'button_link' 		=> '',
					'newtab' 		=> '',
				...
				array(
					...
					'title' 		=> esc_html__( 'Join Our Community', 'clever-fox' ),
					'description' 		=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'clever-fox' ),
					'button_text' 		=> esc_html__( 'Read More', 'clever-fox' ),
					'button_link' 		=> '',
					'newtab' 		=> '',
				...
				array(
					...
					'title' 		=> esc_html__( 'Your Wellness Journey', 'clever-fox' ),
					'description' 		=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'clever-fox' ),
					'button_text' 		=> esc_html__( 'Read More', 'clever-fox' ),
					'button_link' 		=> '',
					'newtab' 		=> '',
				...
				array(
					...
					'title' 		=> esc_html__( 'Relax & Chill', 'clever-fox' ),
					'description' 		=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'clever-fox' ),
					'button_text' 		=> esc_html__( 'Read More', 'clever-fox' ),
					'button_link' 		=> '',
					'newtab' 		=> '',
	...
	return apply_filters(
		'hotel26_get_funfact_default', json_encode(
				...
				array(
					...
					'title' 		=> '35400',
					'subtitle' 		=> '+',
					'text'      	=> esc_html__( 'Drinks', 'clever-fox' ),
				...
				array(
					...
					'title' 		=> '10256',
					'subtitle' 		=> '+',
					'text'      	=> esc_html__( 'Hotel Keys', 'clever-fox' ),
				...
				array(
					...
					'title' 		=> '51000',
					'subtitle' 		=> '+',
					'text'      	=> esc_html__( 'World Tour', 'clever-fox' ),
				...
				array(
					...
					'title' 		=> '42500',
					'subtitle' 		=> '+',
					'text'      	=> esc_html__( 'Total People', 'clever-fox' ),
	...
	return apply_filters(
		'hotel26_testimonial_default', json_encode(
				...
				array(
					...
					'title' 		=> esc_html__( 'John D. Alexon', 'clever-fox' ),
					'subtitle' 		=> esc_html__( 'Manager', 'clever-fox' ),
					'text'      	=> esc_html__( '5', 'clever-fox' ),
					'description'      	=> esc_html__( 'There many variations passages of Lorem Ipsum available but the majority have suffered alteration in some form, by injected .', 'clever-fox' ),
				...
				array(
					...
					'title' 		=> esc_html__( 'Michael Dean', 'clever-fox' ),
					'subtitle' 		=> esc_html__( 'Event Member', 'clever-fox' ),
					'text'      	=> esc_html__( '5', 'clever-fox' ),
					'description'      	=> esc_html__( 'There many variations passages of Lorem Ipsum available but the majority have suffered alteration in some form, by injected .', 'clever-fox' ),
 ...
 function hotel26_pricing_default() {
	return apply_filters(
		'hotel26_pricing_default', json_encode(
				 array(
				array(
					'title'			=> esc_html__('Single Room' , 'clever-fox' ),
					'subtitle'		=> esc_html__( 'Most Popular', 'clever-fox' ),
					'text'			=> esc_html__( '$49', 'clever-fox' ),
					'text2'			=> esc_html__( '/Per Night', 'clever-fox' ),
					'text3'			=> esc_html__( 'ALL PLANS INCLUDED', 'clever-fox' ),
					'text7'			=> esc_html__( 'family,signature', 'clever-fox' ),
					'button_text'	=> esc_html__( 'Choose Your Plan', 'clever-fox' ),
					'button_link'	=> '',
					'newtab'		=> '',
					'nofollow'		=> '',
					'social_repeater'		=> json_encode(
				...
				array(
					'title'			=> esc_html__('Deluxe Room' , 'clever-fox' ),
					'subtitle'		=> esc_html__( 'Best Value', 'clever-fox' ),
					'text'			=> esc_html__( '$49', 'clever-fox' ),
					'text2'			=> esc_html__( '/Per Night', 'clever-fox' ),
					'text3'			=> esc_html__( 'ALL PLANS INCLUDED', 'clever-fox' ),
					'text7'			=> esc_html__( 'deluxe', 'clever-fox' ),
					'button_text'	=> esc_html__( 'Choose Your Plan', 'clever-fox' ),
					'button_link'	=> '',
					'newtab'		=> '',
					'nofollow'		=> '',
				...
				array(
					'title'			=> esc_html__('Business Room' , 'clever-fox' ),
					'subtitle'		=> esc_html__( 'Recommended', 'clever-fox' ),
					'text'			=> esc_html__( '$199', 'clever-fox' ),
					'text2'			=> esc_html__( '/Per Night', 'clever-fox' ),
					'text3'			=> esc_html__( 'ALL PLANS INCLUDED', 'clever-fox' ),
					'text7'			=> esc_html__( 'deluxe,signature', 'clever-fox' ),
					'button_text'	=> esc_html__( 'Choose Your Plan', 'clever-fox' ),
					'button_link'	=> '',
					'newtab'		=> '',
					'nofollow'		=> '',
				...
				array(
					'title'			=> esc_html__('Luxury Room' , 'clever-fox' ),
					'subtitle'		=> esc_html__( 'Recommended', 'clever-fox' ),
					'text'			=> esc_html__( '$69', 'clever-fox' ),
					'text2'			=> esc_html__( '/Per Night', 'clever-fox' ),
					'text3'			=> esc_html__( 'ALL PLANS INCLUDED', 'clever-fox' ),
					'text7'			=> esc_html__( 'luxury', 'clever-fox' ),
					'button_text'	=> esc_html__( 'Choose Your Plan', 'clever-fox' ),
					'button_link'	=> '',
					'newtab'		=> '',
					'nofollow'		=> '',
	...
	return apply_filters(
		'hotel26_get_room_default', json_encode(
				...
				array(
					...
					'title'           => esc_html__( '<span class="color-secondary">Deluxe</span> Room 1', 'clever-fox' ),
					'subtitle'        => esc_html__( 'Starting at <br><span class="fw-bold">$199</span> / <span class="color-secondary">Night</span>','clever-fox' ),
					'button_text'        => esc_html__( 'Book Now','clever-fox' ),
					'button_link'        => '',
					'newtab'		=>	'',
					'nofollow'		=>	'',
				...
				array(
					...
					'title'        => esc_html__( '<span class="color-secondary">Deluxe</span> Room 2', 'clever-fox' ),
					'subtitle'           => esc_html__( 'Starting at <br><span class="fw-bold">$199</span> / <span class="color-secondary">Night</span>', 'clever-fox' ),
					'button_text'        => esc_html__( 'Book Now','clever-fox' ),
					'button_link'        => '',
					'newtab'		=>	'',
				...
				array(
					...
					'title'           => esc_html__( '<span class="color-secondary">Deluxe</span> Room 3', 'clever-fox' ),
					'subtitle'           => esc_html__( 'Starting at <br><span class="fw-bold">$109</span> / <span class="color-secondary">Night</span>', 'clever-fox' ),
					'button_text'        => esc_html__( 'Book Now','clever-fox' ),
					'button_link'        => '',
					'newtab'		=>	'',
					'nofollow'		=>	'',
