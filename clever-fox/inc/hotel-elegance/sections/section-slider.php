...
?>
<section id="slider-section" class="slider-wrapper style2 home-2 st-py-default wow fadeIn">	
	<div class="main-slider owl-carousel">
		<?php
			...
			foreach ( $hotel26_slider as $hotel26_slide_item ) {
				...
				$hotel26_repeater_button2 = ! empty( $hotel26_slide_item->button2_text) ? apply_filters( 'hotel_26_translate_single_string', $hotel26_slide_item->button2_text,'slider section' ) : '';
				$hotel26_repeater_button2_link = ! empty( $hotel26_slide_item->button2_link ) ? apply_filters( 'hotel_26_translate_single_string', $hotel26_slide_item->button2_link, 'slider section' ) : '';		
				$hotel26_repeater_button3_link = ! empty( $hotel26_slide_item->link ) ? apply_filters( 'hotel_26_translate_single_string', $hotel26_slide_item->link, 'slider section' ) : '';		
			...
			<div class="theme-slider">
				<div class="theme-table">
					<div class="theme-table-cell">
						<div class="container">                                
							<div class="theme-content text-<?php echo esc_attr($hotel26_rtl); ?>">
	...
	<div class="container booking-container">
		<div class="row">
			...
			<div class="col-lg-4">
				<div id="booking-section" class="booking-section style2 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
