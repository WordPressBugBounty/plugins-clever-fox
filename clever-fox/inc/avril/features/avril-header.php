	 ...
	 */
		...
		class Avril_social__section_upgrade extends WP_Customize_Control {
			...
			<?php }elseif ( 'Axivo' == $cleverfox_theme->name){ ?>
				...
				<a class="customizer_social_upgrade_section up-to-pro"  href="https://www.nayrathemes.com/axivo-pro/" target="_blank"  style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>		
